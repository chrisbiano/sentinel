// Sentyra — the heartbeat. Supabase Cron pings this every minute; it fires due
...
// the whole day window by the user's offset (yesterday's evening events would
// leak into today's brief). Guess UTC midnight, see what wall-clock that is in
// the zone, and correct by the difference.
...
// Events Chris wrapped up in Sentyra (event_notes.done) are marked (done).
